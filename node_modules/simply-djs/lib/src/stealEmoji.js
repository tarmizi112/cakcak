    ...
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            if (message.commandId) {
                interaction = message;
                if (!interaction.member.permissions.has(discord_js_1.Permissions.FLAGS.MANAGE_EMOJIS_AND_STICKERS))
                ...
                if (!message.member.permissions.has(discord_js_1.Permissions.FLAGS.MANAGE_EMOJIS_AND_STICKERS))
                    ...
                    if (msg.startsWith('http')) {
                        message.guild.emojis
                            ...
                            const embed = new discord_js_1.MessageEmbed()
                                .setTitle((((_a = options.embed) === null || _a === void 0 ? void 0 : _a.title) ||
                        ...
                        message.guild.emojis
                            ...
                            var _e, _f, _g, _h;
                            const embed = new discord_js_1.MessageEmbed()
                                .setTitle((((_e = options.embed) === null || _e === void 0 ? void 0 : _e.title) ||
                                `Successfully added the emoji.\n\nEmoji Name: \`{name}\`\nEmoji ID: \`{id}\``)
                                .replaceAll('{name}', emoji.name)
                                .replaceAll('{id}', emoji.id)
                                .replaceAll('{url}', emoji.url))
