...
function calculator(interaction, options = {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            options.buttons = {
                numbers: ((_a = options.buttons) === null || _a === void 0 ? void 0 : _a.numbers) || 'SECONDARY',
                symbols: ((_b = options.buttons) === null || _b === void 0 ? void 0 : _b.symbols) || 'PRIMARY',
                delete: ((_c = options.buttons) === null || _c === void 0 ? void 0 : _c.delete) || 'DANGER'
            };
            let message;
            ...
            const filter = (button) => {
                var _a;
                return ((_a = button.user) === null || _a === void 0 ? void 0 : _a.id) ===
