        ...
        if (button.isButton()) {
            try {
                ...
                if (button.customId === 'no-sug') {
                    ...
                    if (button.member.permissions.has(discord_js_1.Permissions.FLAGS.ADMINISTRATOR)) {
                    ...
                    else if (!button.member.permissions.has(discord_js_1.Permissions.FLAGS.ADMINISTRATOR)) {
