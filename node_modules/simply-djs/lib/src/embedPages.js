...
function embedPages(message, pages, options = {}) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            options.buttons = {
                firstBtn: {
                    style: ((_f = (_e = options.buttons) === null || _e === void 0 ? void 0 : _e.firstBtn) === null || _f === void 0 ? void 0 : _f.style) || 'PRIMARY',
                ...
                nextBtn: {
                    style: ((_m = (_l = options.buttons) === null || _l === void 0 ? void 0 : _l.nextBtn) === null || _m === void 0 ? void 0 : _m.style) || 'SUCCESS',
                ...
                backBtn: {
                    style: ((_t = (_s = options.buttons) === null || _s === void 0 ? void 0 : _s.backBtn) === null || _t === void 0 ? void 0 : _t.style) || 'SUCCESS',
                ...
                lastBtn: {
                    style: ((_z = (_y = options.buttons) === null || _y === void 0 ? void 0 : _y.lastBtn) === null || _z === void 0 ? void 0 : _z.style) || 'PRIMARY',
                ...
                deleteBtn: {
                    style: ((_5 = (_4 = options.buttons) === null || _4 === void 0 ? void 0 : _4.deleteBtn) === null || _5 === void 0 ? void 0 : _5.style) || 'DANGER',
            ...
            const firstBtn = new discord_js_1.MessageButton()
            ...
            const forwardBtn = new discord_js_1.MessageButton()
            ...
            const backBtn = new discord_js_1.MessageButton()
            ...
            const lastBtn = new discord_js_1.MessageButton()
            ...
            const deleteBtn = new discord_js_1.MessageButton()
            ...
            let pageMovingButtons = new discord_js_1.MessageActionRow();
            ...
            collector.on('end', (coll, reason) => __awaiter(this, void 0, void 0, function* () {
                if (reason === 'del') {
                    ...
                    pageMovingButtons = new discord_js_1.MessageActionRow().addComponents(disab);
