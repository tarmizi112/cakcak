                ...
                try {
                    ...
                    // ------------------------------
                        ...
                        if (check) {
                            ...
                            const close = new discord_js_1.MessageButton()
                                .setStyle(((_3 = (_2 = (_1 = options.ticketSys) === null || _1 === void 0 ? void 0 : _1.buttons) === null || _2 === void 0 ? void 0 : _2.close) === null || _3 === void 0 ? void 0 : _3.style) || 'DANGER')
                            ...
                            const closerow = new discord_js_1.MessageActionRow().addComponents([close]);
                            ch.send({
                        ...
                        interaction.channel.permissionOverwrites
                            ...
                            .catch((err) => { });
                        const X_btn = new discord_js_1.MessageButton()
                            .setStyle(((_12 = (_11 = (_10 = options.ticketSys) === null || _10 === void 0 ? void 0 : _10.buttons) === null || _11 === void 0 ? void 0 : _11.delete) === null || _12 === void 0 ? void 0 : _12.style) || 'DANGER')
                        ...
                        const open_btn = new discord_js_1.MessageButton()
                            .setStyle(((_21 = (_20 = (_19 = options.ticketSys) === null || _19 === void 0 ? void 0 : _19.buttons) === null || _20 === void 0 ? void 0 : _20.reopen) === null || _21 === void 0 ? void 0 : _21.style) || 'SUCCESS')
                        ...
                        const tr_btn = new discord_js_1.MessageButton()
                            .setStyle(((_30 = (_29 = (_28 = options.ticketSys) === null || _28 === void 0 ? void 0 : _28.buttons) === null || _29 === void 0 ? void 0 : _29.transcript) === null || _30 === void 0 ? void 0 : _30.style) || 'PRIMARY')
                        ...
                        const attach = new discord_js_1.MessageAttachment(Buffer.from(response.join(`\n`), 'utf-8'), `${use.user.tag}.txt`);
                        setTimeout(() => __awaiter(this, void 0, void 0, function* () {
                        ...
                        const yes = new discord_js_1.MessageButton()
                            .setCustomId('yea_del')
                            .setLabel('Delete')
                            .setStyle('DANGER');
                        const no = new discord_js_1.MessageButton()
                            .setCustomId('dont_del')
                            .setLabel('Cancel')
                            .setStyle('SUCCESS');
                        const row = new discord_js_1.MessageActionRow().addComponents([yes, no]);
                        ...
                        interaction.channel.permissionOverwrites
                            ...
                            .catch((err) => { });
                        const close = new discord_js_1.MessageButton()
                            .setStyle(((_41 = (_40 = (_39 = options.ticketSys) === null || _39 === void 0 ? void 0 : _39.buttons) === null || _40 === void 0 ? void 0 : _40.close) === null || _41 === void 0 ? void 0 : _41.style) || 'DANGER')
                            ...
                            winArr.forEach((name) => __awaiter(this, void 0, void 0, function* () {
                                yield interaction.guild.members
                                    ...
                                    const gothe = new discord_js_1.MessageButton()
                                        ...
                                        .setStyle('LINK')
                                        .setURL(msg.url);
                                    const entrow = new discord_js_1.MessageActionRow().addComponents([gothe]);
                                    return user
