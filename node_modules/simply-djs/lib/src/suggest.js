...
function suggestSystem(message, options = {}) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            options.buttons = {
                upvote: {
                    style: ((_d = (_c = options.buttons) === null || _c === void 0 ? void 0 : _c.upvote) === null || _d === void 0 ? void 0 : _d.style) || 'PRIMARY',
                    emoji: ((_f = (_e = options.buttons) === null || _e === void 0 ? void 0 : _e.upvote) === null || _f === void 0 ? void 0 : _f.emoji) || '☑️'
                },
                downvote: {
                    style: ((_h = (_g = options.buttons) === null || _g === void 0 ? void 0 : _g.downvote) === null || _h === void 0 ? void 0 : _h.style) || 'DANGER',
            ...
            const surebtn = new discord_js_1.MessageButton()
                .setStyle('SUCCESS')
                .setLabel('Yes')
                .setCustomId('send-sug');
            const nobtn = new discord_js_1.MessageButton()
                .setStyle('DANGER')
                .setLabel('No')
                .setCustomId('nope-sug');
            const row1 = new discord_js_1.MessageActionRow().addComponents([surebtn, nobtn]);
            const embedo = new discord_js_1.MessageEmbed()
            ...
            collect.on('collect', (b) => __awaiter(this, void 0, void 0, function* () {
                ...
                if (b.customId === 'send-sug') {
                    ...
                    const approve = new discord_js_1.MessageButton()
                    ...
                    const no = new discord_js_1.MessageButton()
                        ...
                        .setCustomId('no-sug');
                    const row = new discord_js_1.MessageActionRow().addComponents([approve, no]);
                    yield ch
