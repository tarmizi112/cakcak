        ...
        return new Promise((resolve) => __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const acceptEmbed = new discord_js_1.MessageEmbed()
                    ...
                    .setFooter(((_c = options.embed) === null || _c === void 0 ? void 0 : _c.credit) === false
                ...
                const accep = new discord_js_1.MessageActionRow().addComponents([accept, decline]);
                let m;
                if (interaction) {
                ...
                collector.on('collect', (button) => __awaiter(this, void 0, void 0, function* () {
                    ...
                    if (button.customId == 'deny-ttt') {
                        ...
                        const idleClr = ((_m = (_l = options.buttons) === null || _l === void 0 ? void 0 : _l.idle) === null || _m === void 0 ? void 0 : _m.style) || 'SECONDARY';
                        const XClr = ((_p = (_o = options.buttons) === null || _o === void 0 ? void 0 : _o.X) === null || _p === void 0 ? void 0 : _p.style) || 'DANGER';
                        const OClr = ((_r = (_q = options.buttons) === null || _q === void 0 ? void 0 : _q.O) === null || _r === void 0 ? void 0 : _r.style) || 'PRIMARY';
                        const Plrs = {
                            user: 0,
                        ...
                        const epm = new discord_js_1.MessageEmbed()
                            .setTitle('Lets play TicTacToe.')
                            .setColor(((_s = options.embed) === null || _s === void 0 ? void 0 : _s.color) || '#075fff')
                            .setFooter(((_t = options.embed) === null || _t === void 0 ? void 0 : _t.credit) === false
                        ...
                        function ttt(m) {
                            return __awaiter(this, void 0, void 0, function* () {
                                ...
                                const b3 = new discord_js_1.MessageButton()
                                    .setStyle(Plrs.b3.style)
                                    .setEmoji(Plrs.b3.emoji)
                                    .setCustomId('b3')
                                    .setDisabled(Plrs.b3.disabled);
                                const c1 = new discord_js_1.MessageButton()
                                    .setStyle(Plrs.c1.style)
                                    .setEmoji(Plrs.c1.emoji)
                                    .setCustomId('c1')
                                    .setDisabled(Plrs.c1.disabled);
                                const c2 = new discord_js_1.MessageButton()
                                    .setStyle(Plrs.c2.style)
                                    .setEmoji(Plrs.c2.emoji)
                                    .setCustomId('c2')
                                    .setDisabled(Plrs.c2.disabled);
                                const c3 = new discord_js_1.MessageButton()
                                    .setStyle(Plrs.c3.style)
                                    .setEmoji(Plrs.c3.emoji)
                                    .setCustomId('c3')
                                    .setDisabled(Plrs.c3.disabled);
                                const a = new discord_js_1.MessageActionRow().addComponents([a1, a2, a3]);
                                const b = new discord_js_1.MessageActionRow().addComponents([b1, b2, b3]);
                                const c = new discord_js_1.MessageActionRow().addComponents([c1, c2, c3]);
                                const buttons = [a, b, c];
