...
function ticketSystem(message, options = {}) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const ticketbtn = new discord_js_1.MessageButton()
                .setStyle(((_a = options === null || options === void 0 ? void 0 : options.button) === null || _a === void 0 ? void 0 : _a.style) || 'PRIMARY')
            ...
            const a = new discord_js_1.MessageActionRow().addComponents([ticketbtn]);
