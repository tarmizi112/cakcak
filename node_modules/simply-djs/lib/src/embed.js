...
function embedCreate(message, options = {}) {
    return __awaiter(this, void 0, void 0, function* () {
        return new Promise((resolve) => __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const done = new discord_js_1.MessageButton()
                    .setLabel('Finish')
                    .setStyle('SUCCESS')
                    .setCustomId('setDone');
                const reject = new discord_js_1.MessageButton()
                    .setLabel('Cancel')
                    .setStyle('DANGER')
                ...
                const slct = new discord_js_1.MessageSelectMenu()
                    .setMaxValues(1)
                    .setCustomId('embed-creator')
                    .setPlaceholder('Embed Creator')
                    .addOptions(menuOptions);
                const row = new discord_js_1.MessageActionRow().addComponents([done, reject]);
                const row2 = new discord_js_1.MessageActionRow().addComponents([slct]);
                ...
                const emb = new discord_js_1.MessageEmbed()
                    .setFooter(((_g = options.embed) === null || _g === void 0 ? void 0 : _g.credit) === false
                ...
                message.channel
                    ...
                    collector.on('collect', (button) => __awaiter(this, void 0, void 0, function* () {
                        ...
                        if (button.customId && button.customId === 'setDelete') {
                            ...
                            else if (!message.member.permissions.has(discord_js_1.Permissions.FLAGS.ADMINISTRATOR)) {
                            ...
                            const btn = new discord_js_1.MessageButton()
                                ...
                                .setStyle('SUCCESS');
                            const btn2 = new discord_js_1.MessageButton()
                                .setLabel('Disable')
                            ...
                            button.reply({
                                ...
                                ephemeral: true,
                                components: [new discord_js_1.MessageActionRow().addComponents([btn, btn2])]
                            });
                            ...
                            const autsel = new discord_js_1.MessageSelectMenu()
                                .setMaxValues(1)
                            ...
                            button.reply({
                                ...
                                ephemeral: true,
                                components: [new discord_js_1.MessageActionRow().addComponents([autsel])]
                            });
                            const titleclr = button.channel.createMessageComponentCollector({
                                filter: btnfilt,
                                idle: 60000
                            ...
                            titleclr.on('collect', (m) => __awaiter(this, void 0, void 0, function* () {
                                ...
                                preview
                                    ...
                                    content: preview.content,
                                    embeds: [
                                        preview.embeds[0].setThumbnail(m.content || ((_z = m.attachments.first()) === null || _z === void 0 ? void 0 : _z.url) || '')
                                    ]
                                })
                                    .catch(() => { });
                            }));
                            ...
                            titleclr.on('collect', (m) => __awaiter(this, void 0, void 0, function* () {
                                ...
                                preview
                                    ...
                                    content: preview.content,
                                    embeds: [
                                        preview.embeds[0].setImage(m.content || ((_1 = m.attachments.first()) === null || _1 === void 0 ? void 0 : _1.url))
                                    ]
                                })
                                    .catch(() => { });
                            }));
                    ...
                    collector.on('end', (collected, reason) => __awaiter(this, void 0, void 0, function* () {
                        if (reason === 'time') {
                            const content = new discord_js_1.MessageButton()
                                .setLabel('Timed Out')
                                .setStyle('DANGER')
                                .setCustomId('timeout|91817623842')
                                .setDisabled(true);
                            const row = new discord_js_1.MessageActionRow().addComponents([content]);
