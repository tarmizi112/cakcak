    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            if (m || reaction.id) {
                ...
                if (!starboard)
                    return;
                const msz = yield ((_a = starboard) === null || _a === void 0 ? void 0 : _a.messages.fetch({
                    limit: 100
                }));
                ...
                if (r.emoji.id == options.emoji ||
                    ...
                    starboard = yield ((_c = (_b = r.message) === null || _b === void 0 ? void 0 : _b.guild.channels) === null || _c === void 0 ? void 0 : _c.fetch(options.channelId, {
                        cache: true
                    }));
                    if (!starboard)
                        return;
                    if (r.count == 0 || !r.count) {
                        const msz = yield ((_d = starboard) === null || _d === void 0 ? void 0 : _d.messages.fetch({
                            limit: 100
                        }));
                        const exist = msz.find((msg) => { var _a, _b; return ((_b = (_a = msg.embeds[0]) === null || _a === void 0 ? void 0 : _a.footer) === null || _b === void 0 ? void 0 : _b.text) == '⭐ | ID: ' + m.id; });
                        if (exist) {
                    ...
                    const embed = new discord_js_1.MessageEmbed()
                        .setAuthor(((_e = options.embed) === null || _e === void 0 ? void 0 : _e.author) || {
                        name: fetch.author.tag,
                        iconURL: fetch.author.displayAvatarURL()
                    })
                        .setColor(((_f = options.embed) === null || _f === void 0 ? void 0 : _f.color) || '#FFC83D')
                        .setDescription(((_g = options.embed) === null || _g === void 0 ? void 0 : _g.description) || fetch.content)
                        .setTitle(((_h = options.embed) === null || _h === void 0 ? void 0 : _h.title) || `Jump to message`)
                        .setURL(fetch.url)
                        .setFooter({ text: '⭐ | ID: ' + fetch.id });
                    if (url) {
                        embed.setImage(url);
                    }
                    const msz = yield ((_j = starboard) === null || _j === void 0 ? void 0 : _j.messages.fetch({
                        limit: 100
                    }));
                    ...
                    const btn2 = new discord_js_1.MessageButton()
                        ...
                        .setStyle('LINK')
                        .setURL(fetch.url);
                    const row = new discord_js_1.MessageActionRow().addComponents([btn, btn2]);
